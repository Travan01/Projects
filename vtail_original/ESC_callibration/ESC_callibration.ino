...
void setup(){
  ...
  DDRD |= B10110000;                                                                    //Configure digital poort 4, 5, 6 and 7 as output.
...
void loop(){
  ...
  if(data == 'a'){
    ...
    if(cal_int != 2000){
      ...
      ///We don't want the esc's to be beeping annoyingly. So let's give them a 1000us puls while calibrating the gyro.
      PORTD |= B10110000;                                                               //Set digital poort 4, 5, 6 and 7 high.
      delayMicroseconds(1000);                                                          //Wait 1000us.
      PORTD &= B01001111;                                                               //Set digital poort 4, 5, 6 and 7 low.
...
void esc_pulse_output(){
  zero_timer = micros();
  PORTD |= B10110000;                                            //Set port 4, 5, 6 and 7 high at once
